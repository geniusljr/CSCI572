...
public class MurMurHashFunction extends HashFunction {
    ...
    public MurMurHashFunction(String charSet) {
    ...
    public BitSet hash(String text) {
        ...
        //Copy From https://github.com/sing1ee/simhash-java/blob/master/src/simhash/MurmurHash.java
        
        byte[] buffer = text.getBytes(Charset.forName(charSet));
        ByteBuffer key = ByteBuffer.wrap(buffer);
        int length = buffer.length, offset = 0, seed = 0;
